...
from App.models import House, User, Facility, Area, HouseImage, Order
...
def user_newhouse():
    ...
    house.desposit= house_dict.get('desposit')
...
@house_blue.route('/images/',methods=['POST'])
def newhouse_iamges():
    ...
    return jsonify(code=status_code.OK,iamge_url=image_url)
...
@house_blue.route('/allsearch/',methods=['GET'])
def house_search():
